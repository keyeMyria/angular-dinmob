...
@Component({
  selector: 'app-devoluciones-pendientes',
  templateUrl: './devoluciones-pendientes.component.html',
  styleUrls: ['./devoluciones-pendientes.component.scss']
})
export class DevolucionesPendientesComponent implements OnInit {
  obras: any = [];
  ventas: any = [];
  totales: any;
    ...
    this.route.paramMap.pipe(
      switchMap((params: ParamMap) => {
        if (params.has("obra")) {
          ...
          return this.obraSrv.getVentasDevolucionesPendientes(params.get("obra"));
        } else {
          return of([]);
        }
      })).subscribe((res: any) => {
